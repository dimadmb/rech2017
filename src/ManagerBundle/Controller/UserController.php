...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $users = $em->getRepository('BaseBundle:User')->findBy([],['id'=>'DESC']);
    ...
    {
        $user = new User();
        $form = $this->createForm('BaseBundle\Form\UserType', $user);
    ...
    {
        $deleteForm = $this->createDeleteForm($user);
        $editForm = $this->createForm('BaseBundle\Form\UserType', $user);
